...
class RejectedGuest extends StatelessWidget {
  const RejectedGuest({super.key});
      ...
      children: [
        Padding(
          ...
          child: ListView.builder(
            itemCount: provider.rejectedGuests.length,
            itemBuilder: (context, index) {
              final guest1 = provider.rejectedGuests[index];
